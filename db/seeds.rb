...
photo = URI.open('https://res.cloudinary.com/dnmgsdi4z/image/upload/v1609769902/HITC_CPH_qywpfj.jpg')
p3.photo.attach(io: photo, filename: "IMHITC.jpg", content_type: "image/jpg")
p3.save!
...
photo = URI.open('https://res.cloudinary.com/dnmgsdi4z/image/upload/v1609767282/portfolio/podiumZV_tczl9f.png')
...
photo = URI.open('https://res.cloudinary.com/dnmgsdi4z/image/upload/v1609767487/portfolio/DGCorner_qpfxzy.jpg')
